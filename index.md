...
* 1st April - Started a Kubernetes project for Denmark's [E-conomic](https://www.e-conomic.dk/)
* 1st December - Started working with Europe's only [Container Solutions](http://container-solutions.com/){:target="_blank"} on an AWS and Kubernetes - Openshift migration project.
